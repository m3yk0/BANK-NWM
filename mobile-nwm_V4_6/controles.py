"""
V 4.6.1 (Mobile bank), v 6 of this code
...
def list_persons_fc(registro=store.contas.copy()):
	all_persons = []
...
def totcontspersec_fc(registro=store.contas.copy(), ignore_none=True):
	"""
...
def capta_fc(registro=store.contas.copy()):
	...
	all_persons = list_persons_fc(registro)
	person_persec = 0
